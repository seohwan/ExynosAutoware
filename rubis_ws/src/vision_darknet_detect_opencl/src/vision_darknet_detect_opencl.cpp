 ...
 */
#include "vision_darknet_detect_opencl.h"
#include <sys/types.h>
#include <unistd.h>
...
namespace darknet
{
    ...
    void Yolo3Detector::load(std::string& in_model_file, std::string& in_trained_file, double in_min_confidence, double in_nms_threshold)
    {
        ...
        int gpus[1] = {0};
        int ngpus = 1;
        // TODO: Multiple GPU is not supported now.
...
{    
    ...
    private_node_handle.param<int>("/vision_darknet_detect_opencl/task_scheduling_flag", task_scheduling_flag, 0);
    private_node_handle.param<int>("/vision_darknet_detect_opencl/task_profiling_flag", task_profiling_flag, 0);
    private_node_handle.param<std::string>("/vision_darknet_detect_opencl/task_response_time_filename", task_response_time_filename_str, "~/Documents/profiling/response_time/vision_darknet_detect_opencl.csv");
    private_node_handle.param<int>("/vision_darknet_detect_opencl/rate", rate, 10);
    private_node_handle.param("/vision_darknet_detect_opencl/task_minimum_inter_release_time", task_minimum_inter_release_time, (double)10);
    private_node_handle.param("/vision_darknet_detect_opencl/task_execution_time", task_execution_time, (double)10);
    private_node_handle.param("/vision_darknet_detect_opencl/task_relative_deadline", task_relative_deadline, (double)10);
    private_node_handle.param("/vision_darknet_detect_opencl/gpu_scheduling_flag", gpu_scheduling_flag, 0);
    private_node_handle.param("/vision_darknet_detect_opencl/gpu_profiling_flag", gpu_profiling_flag, 0);
    private_node_handle.param<std::string>("/vision_darknet_detect_opencl/gpu_execution_time_filename", gpu_execution_time_filename_str, "~/Documents/gpu_profiling/test_yolo_execution_time.csv");
    private_node_handle.param<std::string>("/vision_darknet_detect_opencl/gpu_response_time_filename", gpu_response_time_filename_str, "~/Documents/gpu_profiling/test_yolo_response_time.csv");
    private_node_handle.param<std::string>("/vision_darknet_detect_opencl/gpu_deadline_filename", gpu_deadline_filename_str, "~/Documents/gpu_deadline/yolo_gpu_deadline.csv");
    ...
    if (private_node_handle.getParam("/vision_darknet_detect_opencl/network_definition_file", network_definition_file))
    {
    ...
    if (private_node_handle.getParam("/vision_darknet_detect_opencl/pretrained_model_file", pretrained_model_file))
    {
